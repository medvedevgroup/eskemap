...
//Tests for function const int32_t calcIntersecScore(const PairSketch&, const PairSketch&)//
...
TEST(CalcIntersecScoreTest, SmplTst){
	PairSketch a {make_pair(0, 43), make_pair(1, 44), make_pair(2, 42)};
	PairSketch b {make_pair(0, 40), make_pair(1, 42), make_pair(2, 40)};

	EXPECT_EQ(calcIntersecScore(a, b), -2);
	EXPECT_EQ(a.size(), 3);
	PairSketch::iterator i = a.begin();
	EXPECT_EQ(i->first, 2);
...
//Tests for function const int32_t calcAlgnHshsScore(const PairSketch&, const PairSketch&, const bool&)//
...
TEST(CalcAlgnHshsScore, SmplTst){
	PairSketch a {make_pair(0, 0), make_pair(1, 2), make_pair(2, 3), make_pair(3, 3)};
	PairSketch b {make_pair(0, 1), make_pair(1, 2), make_pair(2, 3), make_pair(3, 3)};
